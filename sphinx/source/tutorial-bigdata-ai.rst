...
**Download**
 ...
 You can download the example as `tutorial.examples.tensorflow-jupyter-gpu <https://raw.githubusercontent.com/occopus/docs/devel/tutorials/tensorflow-jupyter-gpu.tar.gz>`_ .
